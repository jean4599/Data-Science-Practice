...
int main(int argc, char* argv[])
{
    ...
    input_file = argv[2];
    output_file = argv[3];
    cout << "min_support: " << min_support_percent << " input_file: " << input_file << " output_file: " << output_file<<endl;
    ...
    cout << "# of transactions: "<< transactions.size() << endl;
    ...
    cout << "FList_vec size in 419: " << FList_vec.size() << endl;
    // for (int i = 0; i < FList_vec.size(); i++) {  
    //     cout << FList_vec[i].first <<": "<<FList_vec[i].second << endl;
    // }
